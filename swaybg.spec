...
Source0  : https://github.com/swaywm/swaybg/archive/v1.1/swaybg-1.1.tar.gz
...
%prep
%setup -q -n swaybg-1.1
cd %{_builddir}/swaybg-1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626801479
...
cp %{_builddir}/swaybg-1.1/LICENSE %{buildroot}/usr/share/package-licenses/swaybg/841449f83a67bf0e5197b94f9b9b61eb3ff097e0
